        ...
        <div className="footer__inner container__row">
            ...
            <div className="footer__links">
              <div className="footer__pages">
                <Link to="/privacy-policy" onClick={(e) => {handleClick(e.target.pathname)}} onKeyDown={(e) => e.key === "Enter" && handleClick("/privacy-policy")} tabIndex={"0"} className="footer__link">Политика конфиденциальности</Link>
                <Link to="/general-terms" onClick={(e) => {handleClick(e.target.pathname)}} onKeyDown={(e) => e.key === "Enter" && handleClick("/general-terms")} tabIndex={"0"} className="footer__link">Общие условия</Link>
                <Link to="/cookies-policy-page" onClick={(e) => {handleClick(e.target.pathname)}}  onKeyDown={(e) => e.key === "Enter" && handleClick("/cookies-policy-page")} tabIndex={"0"} className="footer__link">Cookies Policy</Link>
              </div>
