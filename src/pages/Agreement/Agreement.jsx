        ...
        <section className="agreement container__row">
            <h1 className="agreement__title">Соглашение об обработке персональных данных</h1>
                <div className="agreement__content">
                    ...
                    <p className="agreement__text">Согласен на получение по электронной почте, посредством смс-сообщений, телефонных звонков, рассылок через сервисы Viber, WhatsApp, Telegram и другие сервисы рекламных и информационных сообщений о товарах/услугах ООО «Ресайклекс», о деятельности ООО «Ресайклекс», о проведении стимулирующих мероприятий рекламного характера.</p>
