            ...
            <h1 className="сookies__title"> Cookies Policy </h1>
                    <div className="сookies__content">
                        ...
                        <div className="сookies-type__wrapper">
                            ...
                            <p className="сookies__text"> <a href="/">Сайт</a> может содержать ссылки на другие веб-сайты, которые имеют собственную политику конфиденциальности, которая может отличаться от политики, принятой <a href="/">Сайте</a>, а поэтому мы не несем за эти веб-сайты ответственность.</p>
                        </div>
