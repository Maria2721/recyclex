                    ...
                    <div className="сookies__content">
                        ...
                        <p className="сookies__list-title">Анализируя более подробно, наши файлы cookie позволяют:</p>
                            <ul className="сookies__list">
                                ...
                                <li className="сookies__list-item list-item_circleList ">анализировать использование сервисов и контента, предоставляемых <a href="/">Сайтом</a>, чтобы оптимизировать ваше пребывание на сайте и предлагаемые возможности.</li>
                            </ul>
                        </div>
                        <div className="сookies-type__wrapper">
                            ...
                            <p className="сookies__text"> <a href="/">Сайт</a> может содержать ссылки на другие веб-сайты, которые имеют собственную политику конфиденциальности, которая может отличаться от политики, принятой <a href="/">Сайтом</a>, а поэтому мы не несем за эти веб-сайты ответственность.</p>
                        </div>
