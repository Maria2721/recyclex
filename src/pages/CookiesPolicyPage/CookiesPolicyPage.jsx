                    ...
                    <div className="сookies__content">
                        ...
                        <p className="сookies__list-title">Анализируя более подробно, наши файлы cookie позволяют:</p>
                            <ul className="сookies__list">
                                ...
                                <li className="сookies__list-item list-item_circleList ">анализировать использование сервисов и контента, предоставляемых emmegi.com, чтобы оптимизировать ваше пребывание на сайте и предлагаемые возможности.</li>
                            </ul>
                        </div>

                        <div className="сookies-type__wrapper">
                            <h3 className="сookies__subtitle_h3">Типы файлов cookie</h3>
                            ...
                            <p className="сookies__text">Эти файлы cookie позволяют нам в анонимной форме собирать и анализировать трафик и использование веб-сайта, чтобы лучше понять и усовершенствовать способ использования сайта посетителями, а также определить, какие страницы и продукты отображаются чаще всего. Этот тип файлов cookie собирает анонимные данные об активности пользователей и о том, как они попадают на Сайт. Эти cookie не являются необходимыми для работы веб-сайта, но обеспечивают лучший опыт просмотра. Аналитические файлы cookie отправляются с самого Сайта или сторонних доменов. В соответствии с действующим законодательством о конфиденциальности для установки этих файлов cookie не требуется ваше предварительное согласие.</p>
                            <h4 className="сookies__subtitle_h4">Аналитические файлы cookie стронних сервисов:</h4>
                            ...
                            <p className="сookies__text"> Эти файлы cookie необходимы для создания профилей пользователей с целью отправки им рекламных сообщений в соответствии с предпочтениями, выраженными пользователем на страницах Сайта. В соответствии с действующим законодательством о конфиденциальности для установки этих файлов cookie требуется ваше предварительное согласие. По этой причине, когда вы заходите на сайт, на видном месте отображается специальный баннер, информирующий вас о том, что (i) на сайте используются профилирующие файлы cookie и что (ii) при закрытии баннера, прокрутке страницы или нажатии на любой элемент страницы вне баннера вы даете согласие на использование cookie. Конечно, вы в любое время можете запретить установку профилирующих файлов cookie, не лишаясь при этом возможности посещения сайта и использования его содержимого.</p>
                            <h4 className="сookies__subtitle_h4">Сторонние веб-сайты и сервисы:</h4>
                            <p className="сookies__text"> Сайт может содержать ссылки на другие веб-сайты, которые имеют собственную политику конфиденциальности, которая может отличаться от политики, принятой emmegi.com, а поэтому мы не несем за эти сайты ответственность.</p>
                        </div>
                        ...
                        <div className="сookies-info__wrapper">
                            ...
                            <p className="сookies__text">Большинство пользователей Google имеет в браузерах предпочтительный файл cookie, называемый PREF. Браузер посылает этот файл cookie с запросами на сайты Google. Файл cookie PREF может хранить ваши настройки и другую информацию, в частности предпочитаемый вами язык (например, русский), количество желаемых результатов поиска для отображения на каждой странице (например, 10 или 20) и ваши предпочтения по активации фильтра безопасного поиска Google SafeSearch. .google.es › types</p>
                            <h4 className="сookies__subtitle_h4">_gat</h4>
                            <p className="сookies__text">Файл cookie _gat является частью сервиса анализа и мониторинга Google Analytics. Это файл cookie, срок действия которого истекает через 10 минут после создания или обновления. Он используется для ограничения частоты запросов аналитических скриптов, чтобы считать посещения пользователя уникальными. developers.google.com › cookie-usage</p>
                            <h4 className="сookies__subtitle_h4">_ga</h4>
                            <p className="сookies__text">Файл cookie _ga является частью сервиса анализа и мониторинга Google Analytics. Это файл cookie, срок действия которого истекает через 2 года после создания или обновления. Он используется для различения пользователей. developers.google.com › cookie-usage</p>
                            ...
                            <h4 className="сookies__subtitle_h4">Как отключить файлы cookie через настройку браузера</h4>
                        ...
                        <div className="сookies__items">
                            ...
                            <div className="сookies__item сookies_divider">
                                <h4 className="сookies__title-link сookies__subtitle_h4">Internet Explorer</h4>
                                <a href="https://support.microsoft.com/ru-ru/help/17442/windows-internet-explorer-delete-manage-cookies" 
                                    className="сookies__link"
                                    target="_blank"
                                    rel="noreferrer">https://support.microsoft.com/ru-ru/help/17442/windows-internet-explorer-delete-manage-cookies</a>
                            </div>
                            <div className="сookies__item сookies_divider">
